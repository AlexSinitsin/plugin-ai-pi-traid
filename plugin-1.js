document.addEventListener("DOMContentLoaded", () => {
  let telephones = document.querySelectorAll('[data-plugin-1="tel"]');
  telephones.forEach((node) => {
    ...
    let placeholderInput = document.createElement('span');
    placeholderInput.textContent = '+7 (___) ___-__-__';
    let placeholderDefault = '+7 (___) ___-__-__';
    placeholderInput.classList.add('placeholder-span');
    ...
    cloneNode.addEventListener('input', (e) => {
      ...
      placeholderInput.textContent = finalResult + placeholderDefault.slice(finalResult.length, placeholderDefault.length);
    })
  })
});
